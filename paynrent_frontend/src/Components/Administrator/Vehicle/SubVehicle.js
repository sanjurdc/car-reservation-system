...
export default function SubVehicle(){
    ...
    var formData=new FormData()
        ...
        formData.append('discount',setDiscount)
        formData.append('icon',icon.bytes)
        var response=await postData('subvehicle/vehiclesubmit', formData ,true)
        if(response.status)
             {
                Swal.fire({
                    icon: 'success',
    ...
    navigate('/dashboard/displayallsubvehicle')
    }
