...
import { useStyles } from "./WhypnrCss";
...
import ListAltIcon from '@mui/icons-material/ListAlt';
    ...
    export default function Whypnr(){
    ...
    var formData=new FormData()
        ...
        var response=await postData('whypnr/submitdata',formData,true)
        if (response.status) {
        Swal.fire({
    ...
    const handleShowWhypnrList=()=>{
    navigate('/dashboard/displayallwhypnr')
    }
               ...
               <Grid container spacing={2}>
                  <Grid container xs={12} className={classes.headingStyle}>
                    <div className={classes.altcenter} >
                       <ListAltIcon  onClick={handleShowWhypnrList} />
